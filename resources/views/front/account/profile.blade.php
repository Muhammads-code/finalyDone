                ...
                <div class="card border-0 shadow mb-4">
                    <form action="" method="post" id="userForm" name="userForm">
                        <div class="card-body  p-4">
                            ...
                            <div class="mb-4">
                                <label for="" class="mb-2">Name <span style=" font-size: 1rem; color: crimson;">*</span></label>
                                <input type="text" name="name" id="name" placeholder="Enter Name" class="form-control" value="{{ $user->name }}">
                                <p></p>
                            </div>
                            <div class="mb-4">
                                <label for="" class="mb-2">Email <span style=" font-size: 1rem; color: crimson;">*</span></label>
                ...
                <div class="card border-0 shadow mb-4">
                    <form action="" method="post" id="changePasswordForm" name="changePasswordForm">
                        <div class="card-body p-4">
                            ...
                            <div class="mb-4">
                                <label for="" class="mb-2">Old Password <span style=" font-size: 1rem; color: crimson;">*</span></label>
                                <input type="password" name="old_password" id="old_password" placeholder="Old Password" class="form-control">
                                <p></p>
                            </div>
                            <div class="mb-4">
                                <label for="" class="mb-2">New Password <span style=" font-size: 1rem; color: crimson;">*</span></label>
                                <input type="password" name="new_password" id="new_password" placeholder="New Password" class="form-control">
                                <p></p>
                            </div>
                            <div class="mb-4">
                                <label for="" class="mb-2">Confirm Password <span style=" font-size: 1rem; color: crimson;">*</span></label>
