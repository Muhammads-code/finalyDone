            ...
            <div class="col-md-5">
                <div class="card shadow border-1 p-5">
                    ...
                    <form action="{{ route('account.processResetPassword') }}" method="post">
                        ...
                        <div class="mb-3">
                            <label for="" class="mb-2">New Password <span style="color:crimson; font-size:1.3rem"> *</span></label>
                ...
                <div class="mt-4 text-center">
                    <p>Do not have an account? <a class="text-danger" href="{{ route('account.login') }}">Back to Login</a></p>
                </div>
            </div>
        </div>
