            ...
            <div class="col">
                <nav aria-label="breadcrumb" class=" rounded-3 p-3 mb-4">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li id="mine" class="breadcrumb-item"><a class="text-danger" href="{{ route('account.myJobs') }}">My Jobs</a></li>
                ...
                <form action="" method="post" id="editJobForm" name="editJobForm">
                    <div class="card border-0 shadow mb-4 ">
                        ...
                        <div class="card-footer  p-4">
                            <button type="submit" class="btn btn-dangerWW">Update Job</button>
                        </div>               
                    </div>
                </form>
