    ...
    <div class="container">     
        <div class="row">
            <div class="col-6 col-md-10 ">
                <h3> <span id="mine1"> <i class="fa-solid fa-circle-dot"></i> Find Jobs</span></h3>  
            </div>
            ...
            <div class="col-md-4 col-lg-3 sidebar mb-4">
                ...
                <form action="" name="searchForm" id="searchForm">
                    <div class="card border-0 shadow p-4">
                        ...
                        <a href="{{ route("jobs") }}" class="btn btn-dark mt-3">Reset</a>
                    </div>
                </form>
            </div>
...
<div class="card-body">
    ...
    <div class="bg-light p-3 border">
        ...
        <p class="mb-0">
            ...
            <span class="ps-1">{{ $job->created_at->format('Y-M-d') }}</span>
        </p>
        ...
        @endif                                                
                                            ...
                                            <div class="d-grid mt-3">
                                                <a href="{{ route('jobDetail',$job->id) }}" class="btn btn-danger btn-lg">Details</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
