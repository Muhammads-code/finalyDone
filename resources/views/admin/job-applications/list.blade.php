                                            ...
                                            <td>
                                                <div class="action-dots ">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        <li><a id="red-hover" class="dropdown-item" onclick="deleteJobApplication({{ $application->id }})" href="javascript:void(0);"  ><i class="fa fa-trash" aria-hidden="true"></i> Delete</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
